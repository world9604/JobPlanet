...
import com.taein.jobplanettest.databinding.ItemReviewBinding

class ReviewViewHolder(val itemBinding : ItemReviewBinding, val viewModel: CompanyListViewModel)
    ...
    val userActionListener = object: CellTypeItemUserActionListener {
        override fun onCellTypeItemClicked(companyId: Int) {
            viewModel.openCellTypeItem(companyId, CompanyCellType.CELL_TYPE_REVIEW)
        }
    }
}